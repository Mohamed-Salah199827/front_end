...
var config = {
		...
		ol: [

			{
				...
				options: {
					...
					legend: "http://kartor.malmo.se/wwwroot_data/bilder/kartsymboler/adresser.png",
					legendBig: "http://kartor.malmo.se/wwwroot_data/bilder/kartsymboler/adresserhoover.png",
					selectOptions: {layers: "malmows:SMA_MALMO_ADRESSREGISTER_PT"},
					showInOpacityTool: false,
					popup :
			...
			
			{
				...
				options: {
					...
					attribution: "@ Malmö stad",
					transparent: true,
					sld: "http://localhost/temp/sld/skolor.sld"
				}
			},
		...
		bl: [
		// {
		// 		init: "L.esri.Layers.TiledMapLayer",
		// 		options: {
		...
		// 		url: "http://kartor.malmo.se/arcgis/rest/services/malmokarta_sv_3857_wms/MapServer",
		// 		options: {
		// 			//reuseTiles: true,  ANVÄND EJ
		// 			transparent: true,
 	// 				category: ["Karta"], 
		...
		// 		// url: "http://kartor.malmo.se/arcgis/rest/services/malmokarta_3857/MapServer",
		// 		options: {
		// 			url: "http://kartor.malmo.se/arcgis/rest/services/malmokarta_ggb_3857_wms/MapServer",
		// 			format: "png24",
		// 			transparent: true,
		// 			f: "json",
		// 			layers: [0],
		...
		plugins: [
					...
					},
					{
						...
						options: {
							...
							_lang: {
								"sv": {
									titleInfo: "<h4>Hejsan svejsan</h4>",
									bodyContent: "<p>Jag är dialogrutans kropp</p>"
								},
								"en": {
									titleInfo: "<h4>Hi-san swi-san</h4>",
					...
					{
						init: "L.Control.BackwardCompat",
						options: {}
					},
					{
						init: "L.Control.BoundaryHole",
						options: {
							holeLayerId: "malmo_ortofoto_ol",
							bgLayerId: "stadskartan_ol"
						}
					},
					// {
					// 	init: "L.Control.Test",
					...
					},
					{
						...
						options: {
							...
							wsOrgProj: "EPSG:3008",
							useProxy: false,
							wsAcUrl: "http://localhost/malmo-api/v1/addresses/autocomplete/", // autocomplete
							wsLocateUrl: "http://localhost/malmo-api/v1/addresses/geolocate/", // geolocate
							popupContent:
										...
										'${function(p) {if (p && p.url_snedbild && p.url_snedbild.length) {return \'<div><a target="_blank" href="\'+p.url_snedbild.replace(\"xyz.malmo.se\", \"kartor.malmo.se\")+\'"><i class=\"fa fa-external-link\"></i> Visa snedbild</a></div>\'} else {return ""}}}',
							acOptions: {
								items: 100
							}
						}
					...
					// --- Toolbar items (order here determines visual order in toolbar) ---
					{
 						...
 						options: {
 							printUrl: "//localhost/print-servlet/leaflet_print/", // //161.52.15.157/geoserver/pdf
 							position: "topright"
 						}
 				 	},
 				 	{
