...
var config = {
		...
		ol: [
			{
				...
				options: {
					params: {
						typeName: "skane:POI_TRAD_MX"
					},
					isEditable: true,
					xhrType: "POST",
					geomType: "point",
					layerId: "Trad_pt",
					displayName: "Träd (punkter)",
					useProxy: false,
		...
		// 		url: "http://kartor.malmo.se/arcgis/services/malmokarta_wms/MapServer/WMSServer",
		// 		options: {
		// 			layers: "0",
		// 			reuseTiles: true,
		// 			transparent: true,
